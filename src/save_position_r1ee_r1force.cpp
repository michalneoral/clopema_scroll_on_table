...
int saveFile(geometry_msgs::Pose pose){
	std::ofstream myfile;
	myfile.open ("/home/neosh/ros_catkin_ws/src/clopema_cvut/clopema_dep_force_position/matlab/forceSensor/transformR1.txt");
	char buffer [256];
...
int main(int argc, char **argv) {
	...
	while (ros::ok()){
		...
		try{
			listener.lookupTransform("/r1_force_sensor", "/r1_ee",  
